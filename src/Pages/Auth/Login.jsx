  ...
  return (
    <div className="bg-gradient-to-r from-blue-600 via-gray-400 to-blue-700 h-screen flex items-center justify-center">
      <div className="max-w-[600px] w-full">
        <div className="bg-gray-800 h-auto py-8 w-full flex items-center justify-center rounded-lg shadow-lg">
          <div>
            ...
            <form onSubmit={handleSubmit}>
              <div>
                <label
                  htmlFor="email"
                  className="text-white block py-2 font-semibold"
                >
                  Email
                </label>
                <input
                ...
                <div className="text-white mt-8 text-center">
                  <p>
                    ...
                    <span className="font-semibold pl-2 text-blue-400">
